/*
    ...
    Part A) This version of the program uses the multiplier 70 with the 
...
main:   stp x29, x30, [sp, -16]!                                                //Saves FP and LR to stack, allocates 16 bytes and preincrements SP
        ...
        mov multiplicand_r, -16843010                                           //Sets the multiplicand register to -16843010
        mov multiplier_r, 70                                                    //Sets the multiplier register to 70
