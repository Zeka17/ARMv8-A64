/*
    ...
    This ARMv8 program that does interger multiplication

    Part A) See file assign2a.asm
    Part B) See file assign2b.asm
    Part C) This version of the program uses the multiplier 256 with the
...
main:   stp x29, x30, [sp, -16]!                                                //Saves FP and LR to stack, allocates 16 bytes and preincrements SP
        ...
        mov multiplicand_r, -252645136                                          //Sets the multiplicand register to -252645136
        mov multiplier_r, -256                                                  //Sets the multiplier register to -256
